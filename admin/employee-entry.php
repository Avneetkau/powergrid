...
<div class="form-group">
<label class="col-md-3 control-label">Sports Selected</label>
<div class="col-md-8">
<div class="example">
           <input name="sports" placeholder="Sports"    class="form-control input-md" type="text" required style="width:320px">               
...
$qr1=mysqli_query($con,"select * from employee_entry where email='$name2'");
...
$qr=mysqli_query($con,"insert into employee_entry(empid,empname,email,mobile,dept,des,dob,gender,sports,password,date,status)values
 ('$empid','$name1','$name2','$name3','$name4','$name5','$name6','$name8','$name9','$name10','$d','$status')")

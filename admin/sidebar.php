                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="add-games.php"><i class="fa fa-plus-circle"></i>Add Games</a></li>
                         ...
                         <li><a href="hod-entry.php"><i class="fa fa-plus-circle"></i> HOD Detail Entry </a></li>
                         <li><a href="show-hoddetail.php"><i class="fa fa-plus-circle"></i>Show HOD Detail </a></li>
                    </ul>
                </li>             

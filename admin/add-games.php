...
<section id="main-content">
	<section class="wrapper">
        ...
        <section class="panel">
                 ...
                 <input type="text" name="gname" class="form-control"  placeholder="Enter Course Name"></div>
                 
                   <div class="form-group">
                                    <label>Place</label>
                 <input type="text" name="place" class="form-control"  placeholder="Enter Course Name"></div>
                 
                   <div class="form-group">
                                    <label>Proposed Month</label>
                 <input type="text" name="pmonth" class="form-control"  placeholder="Enter Course Name"></div>
...
$msg="";
	...
	if(isset($_POST['submit']))
	{
		...
		$qry=mysqli_query($con,"insert into add_games(gname,place,pmonth)values('$name','$name1','$name2')");
		if($qry)
		{

...
<section id="main-content">
	<section class="wrapper">		
        ...
        <section class="panel">
                        ...
                        <?php 
			  $a=$_REQUEST['id'];
			  $qr=mysqli_query($con,"select * from form_submit where id='$a'");
			 ...
			 $empid=$rw['login_id'];
			  ...
			  ?>
                 ...
                 <input type="text" name="login_id" readonly class="form-control" value="<?php  echo $rw['login_id']?>" ></div>
                 <div class="form-group">
                 ...
                 <a href="unreg_employee.php" class="btn btn-default">Back</a>
                            </form>
	...
	{    
		...
		$qry=mysqli_query($con,"update  form_submit set 
		login_='$name1',empname='$name2',email='$name3',mobile='$name4',dept='$name5',des='$name6',dob='$name7',gender='$name8',sports='$name9' where id=".$a );
		if($qry)
		{
    ...
    <div style="padding:10px"><br>
      <table class="table table-striped table-bordered" id="example" >
		...
		?>
          ...
          <li><a href="update-detail.php?id=<?php echo $row2['id'] ?>"  data-toggle="modal">Update</a></li>

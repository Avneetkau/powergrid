...
ob_start();
session_start();
if(!isset($_SESSION['userid']) && !isset($_SESSION['empid']))
{
...
<label class="col-md-3 control-label">HOD Id</label>
<div class="col-md-8">
<input name="hodid" placeholder="hod id" class="form-control input-md" type="text"  style="width:320px">
</div>
</div>
...
<div class="col-md-8">
<input name="name"  placeholder=" Name"  class="form-control input-md" type="text" style="width:320px" required>
</div>
</div>
...
$qr1=mysqli_query($con,"select * from hod where email='$name2'");
...
$qr=mysqli_query($con,"insert into employee_entry(hodid,name,email,mobile,dept,dob,gender,date,status)values
 ('$hodid','$name1','$name2','$name3','$name4','$name5','$name6','$d','$status')")
 or die("insert query error".mysqli_error($con));
	  ...
	  $_SESSION["empid"]="$empid";
	   ...
	   echo"<script>window.location.href='employee-entry.php'</script>";
}	  
}
?>
